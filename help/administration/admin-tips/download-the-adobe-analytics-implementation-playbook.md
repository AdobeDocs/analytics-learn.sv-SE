...
Du anger också om du tänker använda en eVar, händelse, prop eller kombination för att uppnå det du vill spåra.
...
**HUR:** Börja med att lista alla färdiga variabler i Adobe (sida, produkt, geo osv.) samt eVars, props, events och listvariabler i ett Excel-dokument. Detta bör ha en flik per webbplats/rapportserie.
...
* Alla dimensioner/händelser som inte används är antingen &#39;kostnadsfria&#39; eller &#39;tas bort&#39;
   ...
   * Markera dem som så under Namn i taggningsdokumentet, så att du enkelt kan filtrera efter dem. Jag håller dessa omarkerade i taggningsdokumentet (Excel-datafilter) så att användarna inte ser dem
...
* För dimensionerna och händelserna som tas bort rekommenderar jag att du håller reda på dem med arbetsytan:
   * Skapa ett projekt som bara är synligt för administratörer med tre tabeller: Varor, props och händelser. Jag använder &#39;instanser&#39; för de specifika eVars, och för props skapar jag HIT-segment med &#39;prop5 exists&#39;.
...
Kom ihåg att ta med alla digitala egenskaper, även om de inte är taggade med Adobe Analytics. Detta hjälper er att förstå det digitala landskapet och hur användarna interagerar med alla era resurser.
